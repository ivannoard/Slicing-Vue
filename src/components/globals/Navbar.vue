...
<template>
  <nav class="navbar fixed top-0 w-full z-10">
    <div class="container mx-auto flex w-full justify-between">
      <div class="w-8/12 bg-primary brand flex items-center px-10 py-2">
        <div
        ...
        <div class="flex gap-5 text-white justify-end w-full">
      ...
      <div
        class="w-4/12 py-4 px-10 flex gap-3 items-center justify-end bg-white"
      >
